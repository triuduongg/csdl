...
<html lang="en">
  ...
  <body>
    ...
    <div class="welcome" onclick="showprofile()">
      ...
      <small>All rights reserved, 2025 to the Posts and Telecommunications Institute of Technology</small>
    </div>
    <div class="msg">
    ...
    <form class="add-doc show-form" onsubmit ="formcheck()"  action = "addDoc.php" method = "post" enctype = "multipart/form-data">
      ...
      <label><input type="checkbox" name="status" id=""> Private</label>
      ...
      function alldocs(argument){
        ...
        <div class="docs">
         <div class="doc">
          ...
          main.innerHTML = "<h3 style = 'color: slateblue'>There are currently no documents to show</h3>"
         }
        })
      }
      // function getAll(){
    ...
    headers: {
      ...
      const getAudit = ()=>{
        ...
        <div class="doc">
            ...
            <p>Email of the affiliated user account</p>
